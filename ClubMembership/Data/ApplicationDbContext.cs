        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Announcemment>(entity =>
            {
                entity.HasKey(e => e.Idannouncemment)
                    .HasName("PK__Announce__D1C765E7F1F651D8");
            ...
            modelBuilder.Entity<CodeSnippet>(entity =>
            {
                entity.HasKey(e => e.IdcodeSnippet)
                    .HasName("PK__CodeSnip__39AC88212DEE8B9D");
            ...
            modelBuilder.Entity<Member>(entity =>
            {
                entity.HasKey(e => e.IdMember)
                    .HasName("PK__Members__570E7FF0D9E3F7F4");
            ...
            modelBuilder.Entity<Membership>(entity =>
            {
                entity.HasKey(e => e.Idmembership)
                    .HasName("PK__Membersh__4AB98632191F12F0");
            ...
            {
                entity.HasKey(e => e.IdmemrbeshipType)
                    .HasName("PK__Membersh__A3709D5BA53B29C9");

                entity.Property(e => e.IdmemrbeshipType)
                    .ValueGeneratedNever()
                    .HasColumnName("IDMemrbeshipType");
